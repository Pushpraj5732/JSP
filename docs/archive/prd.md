# AYUSH Healthcare Platform — Product Requirements Document (PRD)

**Team:** JSP Coders | **PS Code:** PS-227 | **Problem Statement:** PS-227 — Digital Platform for AYUSH Healthcare Services Management | **Category:** 2 — Student Innovation
...
### 5.5 Multilingual Symptom Chatbot
...
### 5.6 Patient Digital ID Card & QR Code
...
### 5.7 Electronic Medical Records (EMR)
...
- React.js, Node.js, Spring Boot, MySQL, MongoDB (as defined in architecture doc)
